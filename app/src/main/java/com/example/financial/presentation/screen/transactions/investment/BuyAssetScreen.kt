    ...
    TransactionBaseScreen(
        ...
        typeSelector = {
            Row(
                ...
                TransactionTypeIcon(Icons.Outlined.ArrowCircleUp, isSelected = true, selectedColor = Color.Black)
                TransactionTypeIcon(Icons.Outlined.ArrowCircleDown, isSelected = false)
